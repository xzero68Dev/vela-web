...
export const SKU_DETAIL: Record<string, SkuDetail> = {
  ...
  'DARK': {
    name: 'VeLA Dark Concentrate กาแฟสกัดเย็น คั่วเข้ม สายขม 1L',
    tagline: 'สายขม เข้มสะใจ หอม ไม่เปรี้ยว',
    highlights: [
      'คั่วเข้มสายขม หอมเข้ม เข้มข้นสะใจ ไม่เปรี้ยว',
      'เหมาะกับคนที่ชอบกาแฟเข้ม ๆ ลาเต้เย็น หรือแบล็คกาแฟ',
    ...
    description:
      'VeLA Dark คั่วเข้ม (Wash Process) สายขมสะใจ หอมกรุ่น เข้มข้น ไม่เปรี้ยว เหมาะสำหรับคนที่ชอบรสชาติกาแฟเข้มข้นจริงจัง เติมนมได้ตามชอบเพื่อทำลาเต้เย็น หรือดื่มแบล็คกาแฟก็ได้อารมณ์ เป็นหัวเชื้อกาแฟสกัดเย็นเข้มข้น สกัดนานกว่า 20 ชั่วโมง ไม่ใส่น้ำตาล ไม่มีสารปรุงแต่ง',
    howto:
      'ผสมกาแฟ 1 ส่วน : น้ำหรือนม 1 ส่วน (อัตรา 1:1) ปรับความเข้มข้นได้ตามชอบ เหมาะทำลาเต้เย็น หรือดื่มแบล็คกาแฟใส่น้ำแข็ง',
    specs: [
      { label: 'ปริมาณ', value: '1,000 มล. (1 ลิตร)' },
      { label: 'ประเภท', value: 'หัวเชื้อกาแฟสกัดเย็นเข้มข้น (Cold Brew Concentrate)' },
      { label: 'กระบวนการ', value: 'Wash Process' },
    ...
    storage: STORAGE_1L,
    origin: 'Wash Process · คั่วเข้ม (Dark Roast)',
    hashtags: ['กาแฟ', 'ColdBrew', 'กาแฟสกัดเย็น', 'กาแฟคั่วเข้ม', 'หัวเชื้อกาแฟ', 'กาแฟสายขม', 'ลาเต้เย็น', 'VeLA'],
    seoTitle: 'VeLA Dark Concentrate — หัวเชื้อกาแฟสกัดเย็น คั่วเข้ม สายขม 1 ลิตร',
    seoDescription:
      'หัวเชื้อกาแฟสกัดเย็น VeLA Dark คั่วเข้มสายขม หอมเข้ม ไม่เปรี้ยว เหมาะทำลาเต้เย็นหรือแบล็คกาแฟ สกัดเย็นกว่า 20 ชม. ไม่มีน้ำตาล ผลิตสดทุกวัน ส่งฟรี',
  },
